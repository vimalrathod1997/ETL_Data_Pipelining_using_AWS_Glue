...
S3bucket_node1 = glueContext.create_dynamic_frame.from_catalog(
    database="db_youtube_raw_data",
    push_down_predicate="region in ('ca','gb','us')",
    table_name="raw_statistics_data_csv_data",
...
S3bucket_node3 = glueContext.write_dynamic_frame.from_options(
    ...
    format="glueparquet",
    connection_options={
        "path": "s3://bigdata-on-youtube-cleansed-ap-south-1-762644331473-dev/clean-youtube/cleansed-statistics-data-csv-data/",
        "partitionKeys": [],
    },
